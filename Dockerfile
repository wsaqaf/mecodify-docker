...
RUN apt-get update && \
  apt-get -y install supervisor wget git apache2 libapache2-mod-php5 php5-curl mysql-server php5-mysql pwgen php-apc php5-mcrypt zip unzip  && \
...
VOLUME  ["/etc/mysql", "/var/lib/mysql", "/mecodify" ]
